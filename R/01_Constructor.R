...
#' print(tp53)
#' @export
ProteinCodingGene <- function(id, symbol, name, description,
                                chromosome, start, end, proteinID, proteinSeq) {
...
#' print(lncRNA_gene2)
#' @export
lncRNAGene <- function(id, symbol, name, description,
                                chromosome, start, end, lncRNAID, RNASeq) {
    if (!is.character(id) || !is.character(symbol) || !is.character(name) ||
        !is.character(description) || !is.character(chromosome) ||
        !is.numeric(start) || !is.numeric(end) ||
...
#' print(miRNA_gene)
#' @export
microRNAGene <- function(id, symbol, name, description,
                                chromosome, start, end, microRNAID, seedSeq) {
    if (!is.character(id) || !is.character(symbol) || !is.character(name) ||
        !is.character(description) || !is.character(chromosome) ||
        !is.numeric(start) || !is.numeric(end) ||
